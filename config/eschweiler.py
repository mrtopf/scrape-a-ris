...
# leading zeroes.
#
RS = "053340012012"  # Eschweiler

# Currently, only "mongodb" is supported
DB_TYPE = 'mongodb'

# city name
CITY_NAME = "eschweiler"
...
BASE_URL = 'https://rat.eschweiler.de/bi/'  # Mannheim
...
RESULT_STRINGS = {
    ...
    'mehrheitlich zugestimmt': 'BESCHLOSSEN_MEHRHEIT',
    ...
    'einstimmig zugestimmt' : 'BESCHLOSSEN_EINSTIMMIG'
}
